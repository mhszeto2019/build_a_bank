import requests
import uuid
add_acc_url = 'http://0.0.0.0:80/add_account'
get_acc_url = 'http://0.0.0.0:80/get_account_details_by_account_id'
get_sub_acc_url = 'http://0.0.0.0:80/get_sub_account_details_by_account_id'

deposit_url = 'http://0.0.0.0:81/deposit'
withdraw_url = 'http://0.0.0.0:81/withdraw'
transfer_url = 'http://0.0.0.0:81/transfer'


ledger_deposit = 'http://0.0.0.0:82/deposit'
ledger_withdraw = 'http://0.0.0.0:82/withdraw'
ledger_transfer = 'http://0.0.0.0:82/transfer'
